...
namespace RandomStringGenerator {
    public interface IExpression {
        ...
        /// </summary>
        /// <param name="sizeData">pointer to length data generated by ComputeLen</param>
        /// <param name="outputBuffer">buffer to paste data</param>
        unsafe void InsertAsciiBytes( ref int* sizeData, ref byte* outputBuffer);
        /// <summary>
        /// Paste expression result to buffer
        /// </summary>
        /// <param name="sizeData">pointer to length data generated by ComputeLen</param>
        /// <param name="outputBuffer">buffer to paste data</param>
        unsafe void InsertAsciiChars( ref int* sizeData, ref char* outputBuffer);
        /// <summary>
